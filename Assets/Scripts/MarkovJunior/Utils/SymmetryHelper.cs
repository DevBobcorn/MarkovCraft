...
namespace MarkovJunior
{
    static class SymmetryHelper
    {
        ...
        {
            ["()"] = ArrayHelper.Array1D(48, l => l == 0),
            ["(x)"] = ArrayHelper.Array1D(48, l => l == 0 || l == 1),
            ["(z)"] = ArrayHelper.Array1D(48, l => l == 0 || l == 17),
            ["(xy)"] = ArrayHelper.Array1D(48, l => l < 8),
            ["(xyz+)"] = ArrayHelper.Array1D(48, l => l % 2 == 0),
            ["(xyz)"] = ArrayHelper.Array1D(48, true),
